...
export const requestStructuredPairs = async ({ model, chunk, index, total, apiKey, signal }: StructuredPairsParams) => {
 const prompt = [
  ...
  "9. 노래/가사라면 학습용 문장 추출 모드로 바꾸지 말고 입력 텍스트 정리 모드로 처리하세요.",
  "10. 노래/가사라면 입력 텍스트에 실제로 있는 반복만 유지하세요.",
  "11. 노래/가사라면 반복되는 줄을 합치지 말고 삭제하지도 마세요.",
  "12. 노래/가사라면 외부 지식, 기억, 알려진 원곡 가사를 이용해 보완하지 마세요.",
  "13. 노래/가사라면 불명확한 부분을 추측해서 복원하지 말고, 입력 텍스트에 있는 범위만 정리하세요.",
  '14. 노래/가사로 판단한 항목은 {"en":"영어 문장","ko":"한국어 번역","keepDuplicate":true} 형식으로 반환하세요.',
  "",
  "반환 예시:",
